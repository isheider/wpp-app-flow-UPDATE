  ...
  return (
    <ContextMenu.Trigger>
      <div
        ...
        className="w-96 my-anchor-element bg-white border border-gray-200 rounded-lg shadow p-[25px] dark:bg-gray-800 dark:border-gray-700"
      >
        <Handle
          type="target"
          id="top"
        ...
        <Form ref={formRef} onSubmit={handleSubmit}>
          ...
          <CreatableSelect
            ...
            className=" text-base z-10 nodrag focus:outline-0 outline-0"
