...
export default function TemplatesList() {
  ...
  const FlowItem = ({ title, active, triggers, id, handleDeleteFlow }: any) => {
    ...
    return (
      ...
      <div
        className={`max-w-sm h-[310px] w-[300px] mr-3 inline-flex flex-col justify-between mb-3 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700`}
      >
        <div className="top">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row items-center">
            <button
              ...
              className="mt-4 w-full items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
            >
              Deletar
            </button>
          </div>
  ...
  const handleDeleteFlow = useCallback(async (id: any) => {
    confirmAlert({
      title: "Deletar fluxo",
      message: "Tem certeza que quer deletar esse fluxo?",
      buttons: [
        {
          label: "Sim",
          onClick: () => handle(),
    ...
    async function handle() {
      ...
      setFlows((oldFlows: any) =>
        oldFlows.filter((flow: any) => String(flow._id) !== String(id))
      );
